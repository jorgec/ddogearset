...
# XML -> effects, stat naming, bonus-type stacking, set counting. See
# docs/0.5.0/00_ETL_START_HERE.md §7. The dependency runs one way only:
# optimizer imports rules, never the reverse. etl/ imports rules too.
#
