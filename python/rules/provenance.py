...
This module also feeds the ETL's Transform stage: RAID_UPGRADE_TIER_PREFIXES and
_RAID_VERSION_OF_RE are the entity-resolution rules that turn "Epic X" /
"Legendary X" pairs into item_family + item_upgrade edges
(docs/0.5.0/00_ETL_START_HERE.md §6, "clean derivation").
"""
