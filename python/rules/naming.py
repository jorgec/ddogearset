...
The ETL's Transform stage (docs/0.5.0/00_ETL_START_HERE.md §2) moves the FIRST
job — classifying is_skill/is_hireling/is_save, which are pure functions of the
buff — into a build-time `stat` dimension. The naming/matching residue here
stays at runtime because it is a function of what the USER typed.
"""
