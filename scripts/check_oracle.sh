#!/usr/bin/env bash
# Phase 0 gate — docs/0.5.0/01_RECALC_SPEC_AND_PHASED_PLAN.md
#
# The differential oracle for the 0.5.0 recalculation work cannot be regenerated
# once mode:"calculate" is deleted in Phase 6. This script asserts it is present,
